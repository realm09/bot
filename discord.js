...
bot.on('message', async (msg) => {
	...
	else if (command === './about')
	{
		...
		.setTitle('About')
		.addFields(
			{ name: 'Developer : ', value: '𝓡𝓮𝓪𝓵𝓶 ⸸#1337'},
			{ name: 'Language : ', value: 'Javascript'},
			{ name: 'Website : ', value: 'renovatesecurity.xyz'},
		)
		.setTimestamp()
		.setFooter('Contact : 𝓡𝓮𝓪𝓵𝓶 ⸸#1337');
		...
		if(!req)
		{
			msg.channel.send(`> Contact 𝓡𝓮𝓪𝓵𝓶 ⸸#1337 for access ;)`);
		}
